...
class Deal extends Model
{
    ...
    public function getAffiliateUrlAttribute()
    {
        ...
        if (\Illuminate\Support\Str::contains($url, ['amazon.in', 'amazon.com'])) {
            ...
            // Use the merchant's configured store_id if available, otherwise fallback to kridaymart-21
            $storeId = 'kridaymart-21';
            $merchant = $this->merchant;
            if ($merchant && $merchant->store_id) {
                $storeId = $merchant->store_id;
            }
            $queryParams['tag'] = $storeId; // Store ID
