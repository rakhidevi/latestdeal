...
<body>
    <div class="container">
        ...
        <p>You are receiving this email because we received a password reset request for your LatestDeal account.</p>
        <a href="{{ $resetUrl }}" class="btn">Reset Password</a>
        <p style="margin-top: 24px; font-size: 13px; color: #64748b;">This password reset link will expire in 60 minutes. If you did not request a password reset, no further action is required.</p>
        <div class="footer">
