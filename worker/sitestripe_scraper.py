...
def get_sitestripe_link_and_data(url: str) -> dict:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print("🚨 ERROR: Playwright browser profile is LOCKED! 🚨")
            print("This happens if you have another Chrome window open using this profile, or if a zombie chrome.exe process is stuck in the background.")
            print(f"Details: {e}")
