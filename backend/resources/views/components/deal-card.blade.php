  ...
  <div class="space-y-2 p-3 flex flex-col flex-1">
    ...
    <div class="flex items-center justify-between border-t border-red-100 pt-2 dark:border-slate-800 mt-auto">
      ...
      <div class="flex gap-1.5">
        <a href="{{ route('deal.show', $deal->id) }}" class="rounded-lg border border-red-200 bg-white px-2 py-1 text-[11px] font-semibold text-red-700 hover:bg-red-50 dark:border-slate-700 dark:bg-slate-800 dark:text-red-400 dark:hover:bg-slate-700 transition">Details</a>
