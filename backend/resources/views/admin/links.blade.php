...
<div class="max-w-2xl bg-white rounded-lg shadow-sm border p-6">
    ...
    <form class="space-y-6">
        ...
        <button type="button" onclick="generateLink()" class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-2.5 px-4 rounded-xl shadow-md transition-all">Generate Tracked Link</button>
    </form>
